...
//
// Names, default reps and startWeight for the exercises used in the three
// default routines (js/routines.js) come from the "Custom Home Gym
// Hypertrophy Plan" PDF: 2 working sets per exercise (first ~1-2 reps shy of
// failure, second to failure), reps target set to the low end of the
// prescribed range, startWeight set from the plan's suggested weight
// (midpoint, where a range was given).
const DEFAULT_EXERCISES = [
  ...
  { id: 'bb-floor-press', name: 'Barbell Floor Press', equipment: 'Barbell', sets: 2, reps: 8, startWeight: 50 },

  // Preacher curl / EZ bar
  { id: 'ez-preacher-curl', name: 'Preacher Curl (EZ Bar)', equipment: 'Barbell', sets: 3, reps: 10 },
  { id: 'ez-standing-curl', name: 'EZ Curl Bar Biceps', equipment: 'Barbell', sets: 2, reps: 10, startWeight: 15 },
  ...
  { id: 'db-incline-press', name: 'Incline DB Press', equipment: 'Dumbbell', sets: 2, reps: 8, startWeight: 20 },
  { id: 'db-shoulder-press', name: 'Dumbbell Shoulder Press', equipment: 'Dumbbell', sets: 3, reps: 10 },
  { id: 'db-lateral-raise', name: 'Dumbbell Lateral Raises', equipment: 'Dumbbell', sets: 2, reps: 12, startWeight: 5 },
  ...
  { id: 'db-romanian-deadlift', name: 'Dumbbell RDL', equipment: 'Dumbbell', sets: 2, reps: 10, startWeight: 20 },
  ...
  { id: 'cb-lat-pulldown', name: 'Lat Pulldown', equipment: 'Cable', sets: 2, reps: 10, startWeight: 50 },
  { id: 'cb-seated-row', name: 'Seated Cable Row', equipment: 'Cable', sets: 2, reps: 10, startWeight: 50 },
  { id: 'cb-face-pull', name: 'Cable Face Pulls', equipment: 'Cable', sets: 2, reps: 15, startWeight: 12.5 },
  { id: 'cb-tricep-pushdown', name: 'Cable Tricep Pushdowns', equipment: 'Cable', sets: 2, reps: 12, startWeight: 22.5 },
  ...
  { id: 'cb-woodchopper', name: 'Standing Cable Woodchopper', equipment: 'Cable', sets: 2, reps: 12, startWeight: 17.5 },

  // Landmine
  { id: 'lm-press', name: 'Landmine Press', equipment: 'Landmine', sets: 3, reps: 10 },
  { id: 'lm-squat', name: 'Landmine Goblet Squat', equipment: 'Landmine', sets: 2, reps: 10, startWeight: 40 },
  { id: 'lm-row', name: 'Landmine Single-Arm Row', equipment: 'Landmine', sets: 2, reps: 8, startWeight: 30 },
  ...
  { id: 'lm-reverse-lunge', name: 'Landmine Reverse Lunge', equipment: 'Landmine', sets: 2, reps: 10, startWeight: 15 },
  ...
  { id: 'bw-box-step-up', name: 'Box Squats or Step-Ups', equipment: 'Bodyweight', sets: 2, reps: 10 },
...
// The only weights these dumbbell exercises can actually use — auto-progression
